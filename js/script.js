...
(function () {
	...
	$(function () {
		...
		function attachFormValidator(elements) {
			...
			regula.custom({
				name: 'PhoneNumber',
				defaultMessage: 'Numero de teléfono erroneo',
				validator: function() {
			...
			var regularConstraintsMessages = [
				...
				},
				{
					...
					newMessage: "Correo erroneo"
				},
				{
					type: regula.Constraint.Numeric,
					newMessage: "Error dato erroneo"
				},
				{
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					'MF000': 'Correo enviado',
					'MF001': 'Destinatarios invalidos',
					'MF002': 'Error ',
					'MF003': 'Escriba un email valido',
					'MF004': 'Error MF004',
					'MF254': 'Error de red',
					'MF255': 'Error MF255'
				};
