              ...
              <div class="rd-navbar-main-element">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    </li><li class="rd-nav-item"><a class="rd-nav-link" href="index.php#services">Menu</a>
...
</li>                    <li class="rd-nav-item"><a class="rd-nav-link" href="inicioSesion.php">Inicio de sesion</a>
                    </li>
      ...
      <div class="container-fluid">
        <div class="row mb-0 pb-0">
          <div class="col-md-3 project-mary-title text-title">
            <h3 class="project-classic-text">Galería</h3>
          </div>
        </div>

        <div class="mt-0">
          <div class="col-md-10 grid-gallery m-auto slideshow-container">

            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="0">
              <img class="grid-gallery__image" src="images/caras.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="1">
              <img class="grid-gallery__image" src="images/cliente 3.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="2">
              <img class="grid-gallery__image" src="images/clientes 2.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="3">
              <img class="grid-gallery__image" src="images/clientes 4.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="4">
              <img class="grid-gallery__image" src="images/fam2.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="5">
              <img class="grid-gallery__image" src="images/fam3.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="6">
              <img class="grid-gallery__image" src="images/fernandofam.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="7">
              <img class="grid-gallery__image" src="images/unapersona.jpg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="8">
              <img class="grid-gallery__image" src="images/lugar 1.jpeg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="9">
              <img class="grid-gallery__image" src="images/lugar 2.jpeg">
            </span>
            <span class="grid-gallery__item mySlides fades btn_galery"
              data-img="images/new/galery/LW__0052_Layer-2-copy-52.jpg" data-id="10">
              <img class="grid-gallery__image" src="images/caras.jpg">
            </span>
        ...
        <div class="m odal-body">
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-item" id="0">
                <img class="img-fluid" src="images/caras.jpg" alt="LW__0030_Layer-2-copy-30.jpg">
              </div>
              <div class="carousel-item" id="1">
                <img class="img-fluid" src="images/cliente 3.jpg" alt="LW__0007_Layer-2-copy-7.jpg">
              </div>
              <div class="carousel-item" id="2">
                <img class="img-fluid" src="images/clientes 2.jpg" alt="LW__0001_Layer-2-copy.jpg">
              </div>
              <div class="carousel-item" id="3">
                <img class="img-fluid" src="images/clientes 4.jpg" alt="LW__0006_Layer-2-copy-6.jpg">
              </div>
              <div class="carousel-item" id="4">
                <img class="img-fluid" src="images/fam2.jpg" alt="LW__0077_Layer-2-copy-77.jpg">
              </div>
              <div class="carousel-item" id="5">
                <img class="img-fluid" src="images/fam3.jpg" alt="LW__0004_Layer-2-copy-4.jpg">
              </div>
              <div class="carousel-item" id="6">
                <img class="img-fluid" src="images/fernandofam.jpg" alt="LW__0014_Layer-2-copy-14.jpg">
              </div>
              <div class="carousel-item" id="7">
                <img class="img-fluid" src="images/unapersona.jpg" alt="LW__0014_Layer-2-copy-14.jpg">
              </div>
              <div class="carousel-item" id="8">
                <img class="img-fluid" src="images/lugar 1.jpeg" alt="images/lugar 1.jpeg">
              </div>
              <div class="carousel-item" id="9">
                <img class="img-fluid" src="images/lugar 2.jpeg" alt="LW__0014_Layer-2-copy-14.jpg">
              </div>
              <div class="carousel-item" id="10">
                <img class="img-fluid" src="images/caras.jpg" alt="LW__0014_Layer-2-copy-14.jpg">
              </div>
            </div>
